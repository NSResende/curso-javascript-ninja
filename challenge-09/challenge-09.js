...
chamada.
*/
console.log( 'O resultado da subtração é: '+sum(function(num1,num2){return num1 - num2;}));
// ?

console.log( 'O resultado da multiplicação é: '+sum(function(num1,num2){return num1 * num2;}));

// ?

console.log( 'O resultado da divisão é: '+sum(function(num1,num2){return num1 / num2;}));

// ?

console.log( 'O resultado do resto da divisão é: '+sum(function(num1,num2){return num1 % num2;}));
